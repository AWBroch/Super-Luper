//
//  Super_LuperExtensionAUProcessHelper.hpp
...
#include <vector>
#include "Super_LuperExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(Super_LuperExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    Super_LuperExtensionDSPKernel& mKernel;
