...
private let log = Logger(subsystem: "asherwhite.Super-LuperExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<Super_LuperExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try Super_LuperExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? Super_LuperExtensionAudioUnit else {
            log.error("Unable to create Super_LuperExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(Super_LuperExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = Super_LuperExtensionMainView(parameterTree: observableParameterTree)
